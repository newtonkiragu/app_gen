...
class AlternateName(Model):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True, nullable=False, default=autoincrement=True)
    ...
    ge = relationship('Geoname', back_populates='alternate_name', lazy='joined')
    alternate_name = relationship('AlternateName', back_populates='ge', lazy='joined')
...
class Admin1codes(Model):
    ...
    ge = relationship('Geoname', back_populates='admin1codes', lazy='joined')
    admin1codes = relationship('Admin1codes', back_populates='ge', lazy='joined')
...
class Admin2codes(Model):
    ...
    ge = relationship('Geoname', back_populates='admin2codes', lazy='joined')
    admin2codes = relationship('Admin2codes', back_populates='ge', lazy='joined')
...
class Featurecodes(Model):
    ...
    id = Column(Integer, nullable=False, default=autoincrement=True)
...
class Country(Model):
    ...
    areainsqkm = Column(double_precision, comment="Total area of the country in square kilometers")
...
class Timezone(Model):
    ...
    countr = relationship('Country', back_populates='timezone', lazy='joined')
    timezone = relationship('Timezone', back_populates='countr', lazy='joined')
...
class ContactType(Model):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True, nullable=False, default=autoincrement=True, comment="Unique identifier for the address type.")
    ...
    created_at = Column(DateTime, default=text(''2024-08-23 04:24:22.704688'::timestamp without time zone'), comment="Timestamp when the address type was added to the system.")
    updated_at = Column(DateTime, default=text(''2024-08-23 04:24:22.704688'::timestamp without time zone'), comment="Timestamp when the address type was last updated.")
...
class Person(Model):
    ...
    points = Column(Integer, default=text('0'))
    level = Column(Integer, default=text('1'))
    social_media_imported = Column(Boolean, default=False)

    def __repr__(self):
        return f'<{self.__class__.__name__}(email={self.email}, full_name={self.full_name})>'
...
class OrganizationDocuments(Model):
    ...
    organization_id = relationship('Organization', back_populates='organization_documents', lazy='joined')
    organization_documents = relationship('OrganizationDocuments', back_populates='organization_id', lazy='joined')
...
class SocialMediaProfile(Model):
    ...
    or = relationship('Organization', back_populates='social_media_profile', lazy='joined')
    perso = relationship('Person', back_populates='social_media_profile', lazy='joined')
    social_media_profile = relationship('SocialMediaProfile', back_populates='or', lazy='joined')

    social_media_profile = relationship('SocialMediaProfile', back_populates='perso', lazy='joined')
...
class Organization(Model):
    ...
    status = Column(String, nullable=False, default=text(''Pending'::t_organization_status'))
    ...
    associated_peopl = relationship('Person', back_populates='organization', lazy='joined')
    country_of_operatio = relationship('Country', back_populates='organization', lazy='joined')
    organization = relationship('Organization', back_populates='associated_peopl', lazy='joined')

    organization = relationship('Organization', back_populates='country_of_operatio', lazy='joined')
...
class OrganizationContact(Model):
    ...
    status = Column(String, default=text(''New'::t_contact_status'))
    notes = Column(Text)
    organizatio = relationship('Organization', back_populates='organization_contact', lazy='joined')
    perso = relationship('Person', back_populates='organization_contact', lazy='joined')
    organization_contact = relationship('OrganizationContact', back_populates='organizatio', lazy='joined')

    organization_contact = relationship('OrganizationContact', back_populates='perso', lazy='joined')
...
class ContactApplication(Model):
    ...
    organizatio = relationship('Organization', back_populates='contact_application', lazy='joined')
    perso = relationship('Person', back_populates='contact_application', lazy='joined')
    contact_application = relationship('ContactApplication', back_populates='organizatio', lazy='joined')

    contact_application = relationship('ContactApplication', back_populates='perso', lazy='joined')
...
class OrganizationVerification(Model):
    ...
    organizatio = relationship('Organization', back_populates='organization_verification', lazy='joined')
    organization_verification = relationship('OrganizationVerification', back_populates='organizatio', lazy='joined')
...
class OrganizationPrograms(Model):
    ...
    organization_id = relationship('Organization', back_populates='organization_programs', lazy='joined')
    organization_programs = relationship('OrganizationPrograms', back_populates='organization_id', lazy='joined')
...
class PersonOrganizationClaim(Model):
    ...
    status = Column(String, default=text(''Pending_Review'::t_person_application_status'), comment="Pending, Approved, Rejected")
    claim_date = Column(DateTime, default=func.now())
    review_date = Column(DateTime)
    organization_id = relationship('Organization', back_populates='person_organization_claim', lazy='joined')
    person_id = relationship('Person', back_populates='person_organization_claim', lazy='joined')
    person_organization_claim = relationship('PersonOrganizationClaim', back_populates='organization_id', lazy='joined')

    person_organization_claim = relationship('PersonOrganizationClaim', back_populates='person_id', lazy='joined')
...
class OrganizationHierarchy(Model):
    ...
    child_or = relationship('Organization', back_populates='organization_hierarchy', lazy='joined')
    organization_hierarchy = relationship('OrganizationHierarchy', back_populates='child_or', lazy='joined')
...
class OrganizationSdgs(Model):
    ...
    organizatio = relationship('Organization', back_populates='organization_sdgs', lazy='joined')
    organization_sdgs = relationship('OrganizationSdgs', back_populates='organizatio', lazy='joined')
...
class OrganizationClimateCategories(Model):
    ...
    organizatio = relationship('Organization', back_populates='organization_climate_categories', lazy='joined')
    organization_climate_categories = relationship('OrganizationClimateCategories', back_populates='organizatio', lazy='joined')
...
class OrganizationProfile(Model):
    ...
    organizatio = relationship('Organization', back_populates='organization_profile', lazy='joined')
    organization_profile = relationship('OrganizationProfile', back_populates='organizatio', lazy='joined')
...
class DocumentSubmission(Model):
    ...
    review_notes = Column(Text)
    review_date = Column(DateTime)
    organizatio = relationship('Organization', back_populates='document_submission', lazy='joined')
    document_submission = relationship('DocumentSubmission', back_populates='organizatio', lazy='joined')
...
class BoardMember(Model):
    ...
    start_date = Column(Date)
    end_date = Column(Date)
    organizatio = relationship('Organization', back_populates='board_member', lazy='joined')
    perso = relationship('Person', back_populates='board_member', lazy='joined')
    board_member = relationship('BoardMember', back_populates='organizatio', lazy='joined')

    board_member = relationship('BoardMember', back_populates='perso', lazy='joined')
...
class ExecutivePosition(Model):
    ...
    start_date = Column(Date)
    end_date = Column(Date)
    organizatio = relationship('Organization', back_populates='executive_position', lazy='joined')
    perso = relationship('Person', back_populates='executive_position', lazy='joined')
    executive_position = relationship('ExecutivePosition', back_populates='organizatio', lazy='joined')

    executive_position = relationship('ExecutivePosition', back_populates='perso', lazy='joined')
...
class Grant(Model):
    ...
    status = Column(String)
    description = Column(Text)
    dono = relationship('Organization', back_populates='grant', lazy='joined')
    grant = relationship('Grant', back_populates='dono', lazy='joined')
...
class Event(Model):
    ...
    organizatio = relationship('Organization', back_populates='event', lazy='joined')
    event = relationship('Event', back_populates='organizatio', lazy='joined')
...
class EventRegistration(Model):
    ...
    even = relationship('Event', back_populates='event_registration', lazy='joined')
    perso = relationship('Person', back_populates='event_registration', lazy='joined')
    event_registration = relationship('EventRegistration', back_populates='even', lazy='joined')

    event_registration = relationship('EventRegistration', back_populates='perso', lazy='joined')
...
class PersonTraining(Model):
    ...
    perso = relationship('Person', back_populates='person_training', lazy='joined')
    trainin = relationship('Training', back_populates='person_training', lazy='joined')
    person_training = relationship('PersonTraining', back_populates='perso', lazy='joined')

    person_training = relationship('PersonTraining', back_populates='trainin', lazy='joined')
...
class PjFeedback(Model):
    ...
    notes = Column(Text)
    date = Column(Date)
    organizatio = relationship('Organization', back_populates='pj_feedback', lazy='joined')
    perso = relationship('Person', back_populates='pj_feedback', lazy='joined')
    projec = relationship('Project', back_populates='pj_feedback', lazy='joined')
    pj_feedback = relationship('PjFeedback', back_populates='organizatio', lazy='joined')

    pj_feedback = relationship('PjFeedback', back_populates='perso', lazy='joined')

    pj_feedback = relationship('PjFeedback', back_populates='projec', lazy='joined')
...
class Message(Model):
    ...
    recipien = relationship('Person', back_populates='message', lazy='joined')
    message = relationship('Message', back_populates='recipien', lazy='joined')
...
class Project(Model):
    ...
    organizatio = relationship('Organization', back_populates='project', lazy='joined')
    project = relationship('Project', back_populates='organizatio', lazy='joined')
...
class ProjectLocations(Model):
    ...
    location_coordinate = relationship('Geoname', back_populates='project_locations', lazy='joined')
    projec = relationship('Project', back_populates='project_locations', lazy='joined')
    project_locations = relationship('ProjectLocations', back_populates='location_coordinate', lazy='joined')

    project_locations = relationship('ProjectLocations', back_populates='projec', lazy='joined')
...
class VolunteerLog(Model):
    ...
    organizatio = relationship('Organization', back_populates='volunteer_log', lazy='joined')
    perso = relationship('Person', back_populates='volunteer_log', lazy='joined')
    volunteer_log = relationship('VolunteerLog', back_populates='organizatio', lazy='joined')

    volunteer_log = relationship('VolunteerLog', back_populates='perso', lazy='joined')
...
class Training(Model):
    ...
    offering_or = relationship('Organization', back_populates='training', lazy='joined')
    training = relationship('Training', back_populates='offering_or', lazy='joined')
...
class Impact(Model):
    ...
    description = Column(Text)
    organizatio = relationship('Organization', back_populates='impact', lazy='joined')
    projec = relationship('Project', back_populates='impact', lazy='joined')
    impact = relationship('Impact', back_populates='organizatio', lazy='joined')

    impact = relationship('Impact', back_populates='projec', lazy='joined')
...
class UserActivity(Model):
    ...
    details = Column(Text)
    perso = relationship('Person', back_populates='user_activity', lazy='joined')
    user_activity = relationship('UserActivity', back_populates='perso', lazy='joined')
...
class OrganizationTag(Model):
    ...
    organizatio = relationship('Organization', back_populates='organization_tag', lazy='joined')
    ta = relationship('Tag', back_populates='organization_tag', lazy='joined')
    organization_tag = relationship('OrganizationTag', back_populates='organizatio', lazy='joined')

    organization_tag = relationship('OrganizationTag', back_populates='ta', lazy='joined')
...
class OnboardingProgress(Model):
    ...
    step = Column(Integer, default=text('1'))
    completed_at = Column(DateTime)
    organizatio = relationship('Organization', back_populates='onboarding_progress', lazy='joined')
    use = relationship('Person', back_populates='onboarding_progress', lazy='joined')
    onboarding_progress = relationship('OnboardingProgress', back_populates='organizatio', lazy='joined')

    onboarding_progress = relationship('OnboardingProgress', back_populates='use', lazy='joined')
...
class Notification(Model):
    ...
    read_date = Column(DateTime)
    perso = relationship('Person', back_populates='notification', lazy='joined')
    notification = relationship('Notification', back_populates='perso', lazy='joined')
...
class Report(Model):
    ...
    organizatio = relationship('Organization', back_populates='report', lazy='joined')
    report = relationship('Report', back_populates='organizatio', lazy='joined')
...
class ProjectTag(Model):
    ...
    project_id_fk = Column(Integer, ForeignKey('project.id'), nullable=False)
    tag_id_fk = Column(Integer, ForeignKey('tag.id'), nullable=False)
    projec = relationship('Project', back_populates='project_tag', lazy='joined')
    ta = relationship('Tag', back_populates='project_tag', lazy='joined')
    project_tag = relationship('ProjectTag', back_populates='projec', lazy='joined')

    project_tag = relationship('ProjectTag', back_populates='ta', lazy='joined')
...
class OrganizationBadge(Model):
    ...
    badg = relationship('Badge', back_populates='organization_badge', lazy='joined')
    organizatio = relationship('Organization', back_populates='organization_badge', lazy='joined')
    organization_badge = relationship('OrganizationBadge', back_populates='badg', lazy='joined')

    organization_badge = relationship('OrganizationBadge', back_populates='organizatio', lazy='joined')
...
class UserGamification(Model):
    ...
    points_to_next_level = Column(Integer, default=text('100'))
    use = relationship('Person', back_populates='user_gamification', lazy='joined')
    user_gamification = relationship('UserGamification', back_populates='use', lazy='joined')
...
class Leaderboard(Model):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True, nullable=False, default=autoincrement=True)
    person_id_fk = Column(Integer, ForeignKey('person.id'), nullable=False)
    score = Column(Integer, default=text('0'))
    last_updated = Column(DateTime, default=func.now())
    perso = relationship('Person', back_populates='leaderboard', lazy='joined')
    leaderboard = relationship('Leaderboard', back_populates='perso', lazy='joined')
...
class PersonSkill(Model):
    ...
    endorsements = Column(Integer, default=text('0'))
    perso = relationship('Person', back_populates='person_skill', lazy='joined')
    skil = relationship('Skill', back_populates='person_skill', lazy='joined')
    person_skill = relationship('PersonSkill', back_populates='perso', lazy='joined')

    person_skill = relationship('PersonSkill', back_populates='skil', lazy='joined')
...
class PersonExperience(Model):
    ...
    description = Column(Text)
    awards = Column(Text)
    perso = relationship('Person', back_populates='person_experience', lazy='joined')
    person_experience = relationship('PersonExperience', back_populates='perso', lazy='joined')
...
class PersonEducation(Model):
    ...
    end_date = Column(Date)
    description = Column(Text)
    perso = relationship('Person', back_populates='person_education', lazy='joined')
    person_education = relationship('PersonEducation', back_populates='perso', lazy='joined')
...
class PersonCertification(Model):
    ...
    perso = relationship('Person', back_populates='person_certification', lazy='joined')
    person_certification = relationship('PersonCertification', back_populates='perso', lazy='joined')
...
class GamificationChallenge(Model):
    ...
    name = Column(String, nullable=False)
    description = Column(Text)
    points_reward = Column(Integer, default=text('0'))
    badge_reward_id_fk = Column(Integer, ForeignKey('badge.id'))
    start_date = Column(DateTime)
    end_date = Column(DateTime)
    badge_rewar = relationship('Badge', back_populates='gamification_challenge', lazy='joined')
    gamification_challenge = relationship('GamificationChallenge', back_populates='badge_rewar', lazy='joined')
...
class UserChallenge(Model):
    ...
    challeng = relationship('GamificationChallenge', back_populates='user_challenge', lazy='joined')
    perso = relationship('Person', back_populates='user_challenge', lazy='joined')
    user_challenge = relationship('UserChallenge', back_populates='challeng', lazy='joined')

    user_challenge = relationship('UserChallenge', back_populates='perso', lazy='joined')
...
class ProfileUpdateReminder(Model):
    ...
    reminder_count = Column(Integer, default=text('0'))
    next_reminder_date = Column(DateTime)
    perso = relationship('Person', back_populates='profile_update_reminder', lazy='joined')
    profile_update_reminder = relationship('ProfileUpdateReminder', back_populates='perso', lazy='joined')
...
class PointEarningActivity(Model):
    ...
    points_earned = Column(Integer, default=text('0'))
    timestamp = Column(DateTime, default=func.now())
    perso = relationship('Person', back_populates='point_earning_activity', lazy='joined')
    point_earning_activity = relationship('PointEarningActivity', back_populates='perso', lazy='joined')
...
class PersonPublication(Model):
    ...
    url = Column(String)
    description = Column(Text)
    perso = relationship('Person', back_populates='person_publication', lazy='joined')
    person_publication = relationship('PersonPublication', back_populates='perso', lazy='joined')
...
class PersonVolunteerExperience(Model):
    ...
    end_date = Column(Date)
    description = Column(Text)
    perso = relationship('Person', back_populates='person_volunteer_experience', lazy='joined')
    person_volunteer_experience = relationship('PersonVolunteerExperience', back_populates='perso', lazy='joined')
...
class PersonPatent(Model):
    ...
    issue_date = Column(Date, nullable=False)
    description = Column(Text)
    perso = relationship('Person', back_populates='person_patent', lazy='joined')
    person_patent = relationship('PersonPatent', back_populates='perso', lazy='joined')
...
class PersonCourse(Model):
    ...
    description = Column(Text)
    perso = relationship('Person', back_populates='person_course', lazy='joined')
    person_course = relationship('PersonCourse', back_populates='perso', lazy='joined')
...
class PersonOrganizationMembership(Model):
    ...
    end_date = Column(Date)
    description = Column(Text)
    perso = relationship('Person', back_populates='person_organization_membership', lazy='joined')
    person_organization_membership = relationship('PersonOrganizationMembership', back_populates='perso', lazy='joined')
...
class PersonLanguage(Model):
    ...
    person_id_fk = Column(Integer, ForeignKey('person.id'), nullable=False)
    name = Column(String, nullable=False)
    proficiency = Column(String, nullable=False, default=text(''A1'::t_language_proficiency_level'))
    perso = relationship('Person', back_populates='person_language', lazy='joined')
    person_language = relationship('PersonLanguage', back_populates='perso', lazy='joined')
...
class PersonHonorAward(Model):
    ...
    description = Column(Text)
    perso = relationship('Person', back_populates='person_honor_award', lazy='joined')
    person_honor_award = relationship('PersonHonorAward', back_populates='perso', lazy='joined')
...
class Geoname(Model):
    ...
    latitude = Column(double_precision, comment="Latitude coordinate of the location")
    longitude = Column(double_precision, comment="Longitude coordinate of the location")
    ...
    countr = relationship('Country', back_populates='geoname', lazy='joined')
    geoname = relationship('Geoname', back_populates='countr', lazy='joined')
...
class Contact(Model):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True, nullable=False, default=autoincrement=True, comment="Unique identifier for the contact.")
    ...
    priority = Column(Integer, nullable=False, default=text('10'), comment="Ordering priority for displaying or using the contact. Lower value indicates higher priority.")
    ...
    contact_typ = relationship('ContactType', back_populates='contact', lazy='joined')
    perso = relationship('Person', back_populates='contact', lazy='joined')
    contact = relationship('Contact', back_populates='contact_typ', lazy='joined')

    contact = relationship('Contact', back_populates='perso', lazy='joined')
...
class OrganizationAward(Model):
    ...
    description = Column(Text)
    organizatio = relationship('Organization', back_populates='organization_award', lazy='joined')
    organization_award = relationship('OrganizationAward', back_populates='organizatio', lazy='joined')
...
class Skill(Model):
    ...
    description = Column(Text)
    skill_categor = relationship('SkillCategory', back_populates='skill', lazy='joined')
    skill = relationship('Skill', back_populates='skill_categor', lazy='joined')
...
class PersonProject(Model):
    ...
    perso = relationship('Person', back_populates='person_project', lazy='joined')
    person_project = relationship('PersonProject', back_populates='perso', lazy='joined')
